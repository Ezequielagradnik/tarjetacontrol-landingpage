  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-800" role="contentinfo">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div className="col-span-2 sm:col-span-1">
            ...
            >
              ...
              Tarjeta<span className="text-blue-400">Control</span>
            </a>
            <p className="text-slate-400 text-sm leading-relaxed mt-2 max-w-xs">
              Control profesional de cobranzas y liquidaciones con tarjetas para
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">
            &copy; {new Date().getFullYear()} TarjetaControl. Todos los derechos reservados.
          </p>
          <p className="text-xs text-slate-600">
            Hecho con control total en Argentina
          </p>
        </div>
      </div>
    </footer>
